...
public class GraphListLayoutAdapter extends BaseAdapter {
    ...
    private ArrayList<GraphList> listPojo;


    public GraphListLayoutAdapter(Context context, ArrayList<GraphList> listPojo) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        GraphList rowItem = (GraphList) getItem(i);

        holder.title.setText(rowItem.getTitle());
        holder.sub.setText(rowItem.getValue());
